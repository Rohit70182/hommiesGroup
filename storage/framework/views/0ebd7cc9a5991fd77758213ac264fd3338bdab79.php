...
<div class="col-md-12">
  ...
  <div class="card">
    ...
    <form method="post" action="<?php echo e(url('/services/store/sub-service')); ?>" id="subservice-form" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\service-provider-laravel\Modules/Services\Resources/views/sub-service/form.blade.php ENDPATH**/ ?>