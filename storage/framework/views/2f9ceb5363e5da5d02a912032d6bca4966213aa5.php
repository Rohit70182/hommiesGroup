...
?>
<!-- Style Css -->
<link rel="stylesheet" href="<?php echo e(asset('public/dashboard-assets/css/pages-css/index.css')); ?>" />
<!-- Style Css -->
<?php if( Session::has('orig_user') ): ?>
<div class=" p-3 mb-2 bg-primary text-white">

   <span>You are now logged in as <strong><?php echo e(Auth()->user()->name); ?></strong> Click
      <a href="<?php echo e(url('/shadow/return')); ?>">here</a>
      to return back
   </span>
</div><br>
<?php endif; ?>
...
<div class="dash-home-cards">
   ...
   <div class="row row-cols-xxl-4 row-cols-xl-3 row-cols-md-2 row-cols-1 top-cards">
      <div class="col-md-6 col-lg-4 col-xl-3">
         <div class="card">
            <a class="card-body" href="<?php echo e(url('logActivity')); ?>">
               <p class="cart-title">Login History</p>
               <div class="card-results">
                  <h5 class="main-results"><?php echo e(\App\Models\LogActivity::count()); ?></h5>
               </div>
               <div class="widget-icon">
                  <span><i class="fa fa-user" aria-hidden="true"></i></span>
               </div>
            </a>
            <a href="<?php echo e(url('logActivity')); ?>">
               <div id="chart">
      ...
      <div class="col-md-6 col-lg-4 col-xl-3">
         <div class="card">
            <a class="card-body" href="<?php echo e(url('dashboard/users')); ?>">
               <p class="cart-title">Users</p>
               <div class="card-results">
                  <h5 class="main-results"><?php echo e(\App\Models\User::where('role', User::ROLE_USER)->count()); ?></h5>
               </div>
               <div class="widget-icon">
      ...
      <div class="col-md-6 col-lg-4 col-xl-3">
         <div class="card">
            <a class="card-body" href="<?php echo e(url('/logs')); ?>">
               <p class="cart-title">Logs</p>

               <div class="card-results">
                  <h5 class="main-results"><?php echo e(\App\Models\Logger::count()); ?></h5>
               </div>
               <div class="widget-icon">
                  <span><i class="fa fa-sign-in" aria-hidden="true"></i></span>
               </div>
            </a>
            <a href="<?php echo e(url('dashboard/logs')); ?>">
               <div id="chart">
                  <div class="pt-1" style="min-height: 30px;">
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 ">
         <div class="card">
            <a class="card-body" href="<?php echo e(url('notifications')); ?>">
               <p class="cart-title">Notifications</p>
               <div class="card-results">
                  <h5 class="main-results"><?php echo e(\Modules\Notification\Entities\Notification::count()); ?></h5>
               </div>
               <div class="widget-icon">
               ...
               <div class="list-lg-group list-group-flush list-group">
                  <div class="list-group-item-action list-group-item">
                     <div class="media mt-0">
                        <img class="avatar-lg rounded-circle my-auto mr-3" src="<?php echo e(asset('public/assets/images/chartimg1.jpg')); ?>" alt="Image description">
                  ...
                  <div class="list-group-item-action br-t-1 list-group-item">
                     <div class="media mt-0">
                        <img class="avatar-lg rounded-circle my-auto mr-3" src="<?php echo e(asset('public/assets/images/chartimg2.jpg')); ?>" alt="Image description">
                        <div class="media-body">
                           <div class="d-sm-flex align-items-center">
                              <div class="mt-1">
                  ...
                  <div class="list-group-item-action br-t-1 list-group-item">
                     <div class="media mt-0">
                        <img class="avatar-lg rounded-circle my-auto mr-3" src="<?php echo e(asset('public/assets/images/chartimg3.jpg')); ?>" alt="Image description">
                        <div class="media-body">
                           <div class="d-sm-flex align-items-center">
                              <div class="mt-1">
                  ...
                  <div class="list-group-item-action br-t-1 list-group-item">
                     <div class="media mt-0">
                        <img class="avatar-lg rounded-circle my-auto mr-3" src="<?php echo e(asset('public/assets/images/chartimg4.jpg')); ?>" alt="Image description">
                        <div class="media-body">
                           <div class="d-sm-flex align-items-center">
                              <div class="mt-1">
                  ...
                  <div class="list-group-item-action br-t-1 br-br-7 br-bl-7 list-group-item">
                     <div class="media mt-0">
                        <img class="avatar-lg rounded-circle my-auto mr-3" src="<?php echo e(asset('public/assets/images/chartimg5.jpg')); ?>" alt="Image description">
                        <div class="media-body">
                           <div class="d-sm-flex align-items-center">
                              <div class="mt-1">
...
<script type="text/javascript">
  ...
  var userData = <?php echo e(json_encode($userdata)); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\whizzer-yii2-1836-master\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>